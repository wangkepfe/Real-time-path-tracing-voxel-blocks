...
struct __align__(4) Half2
{
    ...
    INL_DEVICE Half2 operator=(const Half2 &rhs)
    {
        a = rhs.a;
        return *this;
    }
    ...
    INL_DEVICE Half2 &operator+=(const Half2 &v)
    {
        a = a + v.a;
        return *this;
    }
    ...
    INL_DEVICE Half2 &operator+=(half v)
    {
        a = a + make_half2(v, v);
        return *this;
    }
...
struct __align__(4) Half4
{
    ...
    INL_DEVICE Half4 operator=(const Half4 &rhs)
    {
        a = rhs.a;
        b = rhs.b;
        return *this;
    ...
    INL_DEVICE Half4 &operator+=(const Half4 &v)
    {
        a = a + v.a;
        b = b + v.b;
        return *this;
    ...
    INL_DEVICE Half4 &operator+=(half v)
    {
        a = a + make_half2(v, v);
        b = b + make_half2(v, v);
        return *this;
    ...
    INL_DEVICE Float4 toFloat4() const
    {
        float2 a1 = __half22float2(a);
        float2 b1 = __half22float2(b);
        return Float4(a1.x, a1.y, b1.x, b1.y);
    }
...
union ushortToHalf
{
    INL_DEVICE ushortToHalf(const unsigned short &v) : us{v} {}
    INL_DEVICE ushortToHalf(const half &v) : hf{v} {}

    INL_DEVICE explicit operator unsigned short() { return us; }
...
INL_DEVICE half PrxLoRcp(half a) { return (half)ushortToHalf(unsigned short(0x7784) - (unsigned short)ushortToHalf(a)); }
// Minimize squared error across {smallest normal to 16384.0}, 2 ops.
INL_DEVICE half PrxLoRsq(half a) { return (half)ushortToHalf(unsigned short(0x59a3) - ((unsigned short)ushortToHalf(a) >> unsigned short(1))); }