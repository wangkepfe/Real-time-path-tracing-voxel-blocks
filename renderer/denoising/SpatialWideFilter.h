...
namespace jazzfusion
{
        ...
        Int2 size)
    {
        ...
        unsigned short maskValue = Load2DUshort1(materialBuffer, Int2(x, y));
...
#pragma unroll
        for (int loopIdx = 0; loopIdx < 25 / stride; ++loopIdx)
        {
            ...
            unsigned short mask = surf2Dread<ushort1>(materialBuffer, loadIdx.x * sizeof(unsigned short), loadIdx.y, cudaBoundaryModeClamp).x;
