...
namespace jazzfusion
{
        ...
        Int2 historySize)
    {
        ...
        unsigned int maskValue = Load2DUshort1(materialBuffer, Int2(x, y));
        unsigned int historyMaskValue = Load2DUshort1(materialHistoryBuffer, Int2(x, y));
...
#pragma unroll
        ...
        Int2 historySize)
    {
        ...
        // Return for straight-to-sky pixel
        unsigned int maskValue = Load2DUshort1(materialHistoryBuffer, Int2(x, y));
        bool isSky = (maskValue == 0);
        if (isSky == true)
        {
            return;
