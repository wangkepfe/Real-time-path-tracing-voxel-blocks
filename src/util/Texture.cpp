...
Texture::Texture()
    : m_width(0), m_height(0), m_depth(0), m_hostEncoding(ENC_INVALID), m_deviceEncoding(ENC_INVALID), m_sizeBytesPerElement(0), m_textureObject(0), m_d_array(0), m_d_mipmappedArray(0), m_d_envCDF_U(0), m_d_envCDF_V(0), m_integral(1.0f)
{
    m_channelFormat.x = 0;
    m_channelFormat.y = 0;
    m_channelFormat.z = 0;
    ...
    memset(&m_textureDescription, 0, sizeof(cudaTextureDesc));
